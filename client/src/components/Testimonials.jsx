...
export default function BlisslyTestimonials() {
    const testimonialsData = [
        {
            quote: "Blissly made undercutting all of our competitors an absolute breeze.",
            name: "Richard Nelson",
            title: "CTO, Slack",
            image: assets.user1,
        },
        {
            quote: "This platform helped us launch our product twice as fast as expected.",
            name: "Ava Johnson",
            title: "Product Manager",
            image: assets.user2,
        },
        {
            quote: "Incredible support and a fantastic experience from start to finish.",
            name: "Liam Carter",
            title: "CEO, BrightTech",
            image: assets.user3,
        },
        {
            quote: "Our team’s productivity skyrocketed after switching to this solution.",
            name: "Sophia Lee",
    ...
    return (
        <>
            ...
            <section className="flex flex-col items-start px-6 md:px-16 lg:px-24 text-sm max-w-6xl mx-auto py-16">

                {/* Purple Label */}
                <div className="flex items-center mr-auto gap-2 text-purple-600 bg-purple-100 rounded-full px-3 py-1">
                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.5 0.5L9.2 5.5L14.5 5.5L10.3 8.7L12 13.5L7.5 10.3L3 13.5L4.7 8.7L0.5 5.5L5.8 5.5L7.5 0.5Z" fill="#9333EA" stroke="#9333EA" strokeWidth="1" strokeLinejoin="round" />
                    </svg>
                    <span>Testimonials</span>
                </div>

                <h1 className="text-3xl font-medium bg-linear-to-r from-purple-800 to-purple-300 text-transparent bg-clip-text mt-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
                    {testimonialsData.map((testimonial, index) => (
                        <div
                            key={index}
                            className="border border-purple-200 p-6 rounded-lg hover:-translate-y-1 hover:shadow-xl hover:border-purple-500 transition duration-500"
                        >
